...
export const PRODUCTS: Product[] = [
...

  {
    ...
    inStock: true,
    comingSoon: false,
    image: `${CDN}/a220-airfrance-1.jpg`,         // ← uploader sur Shopify Admin
    images: [
      `${CDN}/a220-airfrance-1.jpg`,
      `${CDN}/a220-airfrance-2.jpg`,
      `${CDN}/a220-airfrance-3.jpg`,
      `${CDN}/a220-airfrance-4.jpg`,
      `${CDN}/a220-airfrance-lifestyle.jpg`,
    ],
    bestseller: false,
    scale: "1/100",
  },
  ...
  },
  {
    ...
    inStock: false,
    comingSoon: true,
    image: `${CDN}/Airbus_A380_Singapore_Airlines.png`,
    images: [`${CDN}/Airbus_A380_Singapore_Airlines.png`],
    scale: "1/160",
  },
  {
    id: "a380-emirates",
    ...
    inStock: false,
    comingSoon: true,
    image: `${CDN}/Airbus_A380_Emirates.png`,
    images: [`${CDN}/Airbus_A380_Emirates.png`],
    scale: "1/160",
  },
