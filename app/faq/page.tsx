...
const ITEMS = [
  ...
  },
  {
    ...
    a: "Un interrupteur discret est placé sous la maquette. Une pression l'allume pendant environ 20 secondes. La batterie lithium 75 mAh se recharge par USB — câble fourni, temps de charge ~1h.",
  },
  {
